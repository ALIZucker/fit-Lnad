        ...
        <>
            ...
            <Dialog open={IsOpen} onClose={() => setIsOpen(false)} className="relative z-50">
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <Dialog.Panel
                        className="bg-white flex flex-col gap-[3.0651vh] p-6 rounded shadow  lg:w-[43.2177vw] lg:h-[29.3742vh]">
                        <Dialog.Title className="lg:text-desktext20 text-monile14 font-bold">خواهید از حساب کاربری خارج
                            شوید؟</Dialog.Title>
                        <Dialog.Description className="mb-[2.2vh] lg:text-desktext16 text-monile12">
                        ...
                        <div className="flex flex-row gap-3 w-full justify-end h-[5vh]">
                            ...
                            <button
                                ...
                                className="bg-gray-800 text-white px-3 py-2 lg:w-[7vw] w-[25vw] lg:text-desktext16 text-monile12 rounded"
                            >
                                خروج از حساب
                            </button>
                        </div>
