...
function ItemProduct({item}: { item: dataproduct }) {
    return (
        <>
            <a href={`/productDetails/${item.title}`}>
                <div
                    className="lg:w-[21vw] lg:h-[66.05vh] h-[60vh] relative  flex flex-col gap-[1.4578vh] rounded-2xl shadow-md hover:shadow-xl">
                    ...
                    <div className="flex flex-col gap-3 px-3 ">
                        ...
                        <div className="flex flex-col gap-[1.8vh] w-full">
                            ...
                            {
                                item.offPrice !== null ? (
                                    <p className="lg:text-[0.7vw] text-monile12 text-gray-600 line-through">200.000
                                        تومان</p>
                                ) : null
                            }
                        </div>
